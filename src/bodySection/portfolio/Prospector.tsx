  ...
  return (
    <div>
      ...
      <section className="teaser">
        ...
        <p>At some point during a previous job search, I thought it would be wise to make my job hunt more efficient. Less time on mechanics, more time studying companies and their needs, which is what employers like to see.</p>
